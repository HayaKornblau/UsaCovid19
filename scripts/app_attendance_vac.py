...
def report():
    ...
    while True:
        try:
            ...
            print(tdiff.days)
            print(tdiff.seconds)
            cDaysDiff = fromTime.day - tillTime.day  # calendar days diff
            print(cDaysDiff)
            if cDaysDiff != 0:
...
# main
print('Reporting Vacation WH of an employee.. Start\n')
report()
print('Reporting Vacation WH of an employee.. Done!\n')
